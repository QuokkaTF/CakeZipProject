...
@Controller
class SellerController (private val sellerService: SellerService, private val shopService: ShopService){

    @GetMapping("/seller/myshop/{sellerId}")
    ...
    @GetMapping("/seller/myorders/{sellerId}")
